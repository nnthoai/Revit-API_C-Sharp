...
namespace RevitAPI_MEP
{
    ...
    public class Lession1_TaskDialog_4 : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            td.AddCommandLink(TaskDialogCommandLinkId.CommandLink1, "Lựa chọn 1: Xử lý dữ liệu");
            td.AddCommandLink(TaskDialogCommandLinkId.CommandLink2, "Lựa chọn 2: Thoát mà không thay đổi");

            TaskDialogResult result = td.Show();

            if (result == TaskDialogResult.CommandLink1)
            {
                TaskDialog.Show("Thông báo", "Bạn đã chọn Xử lý dữ liệu.");
            }
